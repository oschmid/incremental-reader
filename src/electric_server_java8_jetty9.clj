(ns electric-server-java8-jetty9 ; copied from https://github.com/hyperfiddle/electric-starter-app/blob/main/src/app/electric_server_java8_jetty9.clj
...
(defn wrap-router "A basic path-based routing middleware"
  [next-handler]
  (fn [ring-req]
    (case (:uri ring-req)
      ...
      "/logout" (res/set-cookie (res/response) "REPL_AUTH" "" {:max-age 0})
...
(defn not-found-handler [_ring-request]
  (-> (res/not-found (str "Not found " (:uri _ring-request)))
      (res/content-type "text/plain")))
